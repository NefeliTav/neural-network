...
#define TRAIN_IMAGE "./MNIST_for_C/data/train-images.idx3-ubyte"
#define TRAIN_LABEL "./MNIST_for_C/data/train-labels.idx1-ubyte"
#define TEST_IMAGE "./MNIST_for_C/data/t10k-images.idx3-ubyte"
#define TEST_LABEL "./MNIST_for_C/data/t10k-labels.idx1-ubyte"
